import {
  ...
  HttpResponse,
  HttpXhrBackend
} from "./chunk-BGRDGCT6.js";
import {
  XhrFactory
} from "./chunk-L7L5ENGQ.js";
import {
  Inject,
  Injectable,
  NgModule,
...
_InMemoryBackendConfig.ɵfac = function InMemoryBackendConfig_Factory(t) {
  return new (t || _InMemoryBackendConfig)(ɵɵinject(InMemoryBackendConfigArgs));
};
_InMemoryBackendConfig.ɵprov = ɵɵdefineInjectable({
...
_HttpClientBackendService.ɵfac = function HttpClientBackendService_Factory(t) {
  return new (t || _HttpClientBackendService)(ɵɵinject(InMemoryDbService), ɵɵinject(InMemoryBackendConfig, 8), ɵɵinject(XhrFactory));
};
_HttpClientBackendService.ɵprov = ɵɵdefineInjectable({
...
_HttpClientInMemoryWebApiModule.ɵfac = function HttpClientInMemoryWebApiModule_Factory(t) {
  return new (t || _HttpClientInMemoryWebApiModule)();
};
_HttpClientInMemoryWebApiModule.ɵmod = ɵɵdefineNgModule({
  type: _HttpClientInMemoryWebApiModule
});
_HttpClientInMemoryWebApiModule.ɵinj = ɵɵdefineInjector({});
...
_InMemoryWebApiModule.ɵfac = function InMemoryWebApiModule_Factory(t) {
  return new (t || _InMemoryWebApiModule)();
};
_InMemoryWebApiModule.ɵmod = ɵɵdefineNgModule({
  type: _InMemoryWebApiModule
});
_InMemoryWebApiModule.ɵinj = ɵɵdefineInjector({});
